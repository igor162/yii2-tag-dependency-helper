...
namespace igor162\TagDependencyHelper\tests;

use igor162\TagDependencyHelper\NamingHelper;
use igor162\TagDependencyHelper\TagDependencyTrait;
use igor162\TagDependencyHelper\tests\models\Post;
use igor162\TagDependencyHelper\tests\models\PostComposite;
use igor162\TagDependencyHelper\tests\models\PostCompositeNoOverride;
use igor162\TagDependencyHelper\tests\models\PostNoTrait;
use Yii;
...
class DatabaseTest extends \PHPUnit_Extensions_Database_TestCase
{
    ...
    {
        $changed = false;
        /** @var \yii\caching\Cache|\igor162\TagDependencyHelper\LazyCache $cache */
        $cache = Yii::$app->cache;
    ...
    public function testCompositeTag()
    {
        ...
        $this->assertEquals(
            'igor162\TagDependencyHelper\tests\models\PostComposite[CompositeTag(author_id):(2)]',
